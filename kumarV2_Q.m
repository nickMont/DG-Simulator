function q1q2q3q4_dot = kumarV2_Q(tremaining,q1q2q3q4)
...
global tP_GG PP1_GG PP2_GG PP3_GG tmax_GG flagRunV3
% if flagRunV3==1
%     depr=9001
%     kumarV3Const;
% end
...
for i=1:nX
    for j=1:nX
        P1(i,j)=interp1(tP,reshape(PP1(i,j,:),[tqLen,1]),tmax-tremaining);
        P2(i,j)=interp1(tP,reshape(PP2(i,j,:),[tqLen,1]),tmax-tremaining);
        P3(i,j)=interp1(tP,reshape(PP3(i,j,:),[tqLen,1]),tmax-tremaining);
    end
end
