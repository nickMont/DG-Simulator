...
% LH2 unfinished for OL case
% generation of uConP matrix needs to be redone with blocks

tmax=2;
lookAheadTime=0; %number of steps to look ahead in optimization; set 0 to use t_remaining instead
dt=1;
MCmax=1;
...
for MCL=1:MCmax
    ...
    %cost matrices
    QfPur=10*[eyeHalfNX zerosHalfNX; zerosHalfNX zerosHalfNX];
    QstepPur=zeros(nX,nX);
    RPur=5*eye(nU);  %NOTE: discrete R = continuous R*dt^2
    RPurScaled=RPur*dt^2;
    
    QfEva=10*[eyeHalfNX zerosHalfNX; zerosHalfNX zerosHalfNX];
